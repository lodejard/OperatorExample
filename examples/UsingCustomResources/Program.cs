...
#pragma warning restore CA1031 // Do not catch general exception types
        ...
        private async Task ApplyTicketProviderDefinitionAsync(CancellationToken cancellationToken)
        {
            ...
            var ticketProviderCrd = await _generator.GenerateCustomResourceDefinitionAsync<V1alpha1TicketProvider>("Cluster");
        ...
        private async Task ApplyTicketDefinitionAsync(CancellationToken cancellationToken)
        {
            ...
            var ticketCrd = await _generator.GenerateCustomResourceDefinitionAsync<V1alpha1Ticket>("Namespaced");
